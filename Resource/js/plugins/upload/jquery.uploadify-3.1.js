		...
		init : function(options, swfUploadOptions) {
			...
			return this.each(function() {
				...
				var settings = $.extend({
					...
					fileTypeExts    : '*.gif; *.jpg; *.png,*.jpeg',              // Allowed extensions in the browse dialog (server-side validation should also be used)
				...
				var swfUploadSettings = {
					...
					use_query_string         : (settings.method == 'post'),
