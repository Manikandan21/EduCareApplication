<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.Master" AutoEventWireup="true" CodeBehind="StudentInfo.aspx.cs" Inherits="ILogisticsApplication.Students.StudentInfo" %>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Student Information <small>Manage student details</small></h5>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (StudentName != undefined && StudentName!="") {
                ...
                BindStudentData(null, null, StudentName);
            } else {
                formSource = 1;
        ...
        $(".ddlSection").change(function () {
            ...
            BindStudentData(Course, Section,null);
        });
        function BindStudentData(Course, Section,StudentName) {
            try {
                $('#dataTable').dataTable().fnDestroy();
                var JsonData = [];
                var url = '';
                var Mode = formSource == 1? 'ForGrid':'ForSearch';
                var Course = Course;
                var Section = Section;
                var Id = 0;
                ...
                if (formSource == 1) {
                    url = '../Handlers/managestudents.ashx?Mode=' + Mode + '&Course=' + Course + '&Section=' + Section + '&Id=' + Id;
                } else {
                    url = '../Handlers/managestudents.ashx?Mode=' + Mode + '&StudentName=' + StudentName ;
                }
        ...
        function OnDelete() {
            ...
            var Request = new XMLHttpRequest();
            var url = '../Handlers/managestudents.ashx?Mode=' + Mode + '&Course=' + Course + '&Section=' + Section + '&Reason=Deleted from Student Info&Id=' + Id;
            Request.open("GET", url, false);
            Request.send();
            var Data = Request.responseText;
            $('#myModal').modal('hide');
