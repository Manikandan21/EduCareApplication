<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="ILogisticsApplication.Login.AdminLogin" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function (e) {
               CheckAuthentication('AdminLogin');
            });
...
<body class="gray-bg">
    ...
    <div class="loginColumns">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="font-bold">Welcome to Admin Portal</h2>
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="txtUsername" value="educare" tabindex="1" maxlength="20" placeholder="Username" />
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" id="txtPassword" value="Binary1!" tabindex="2" maxlength="20" placeholder="Password" />
                    </div>
                    ...
                    <%--<button type="submit" id="btnSubmit" tabindex="3" class="ladda-button ladda-button-demo  btn btn-primary block full-width m-b"  data-style="expand-left">
