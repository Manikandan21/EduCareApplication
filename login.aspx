<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="ILogisticsApplication.Login.UserLogin" %>
...
<body class="gray-bg">
    ...
    <div class="loginColumns">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="font-bold">Welcome to IBinary Soft</h2>
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" id="txtPassword" value="password" tabindex="2" maxlength="20" placeholder="Password" />
                    </div>
