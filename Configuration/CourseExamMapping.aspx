<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CourseExamMapping.aspx.cs" Inherits="ILogisticsApplication.Configuration.CourseExamMapping" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanel" runat="server">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Courses & Exam Mapping <small>Mapping courses and exams</small></h5>
                       <div class="">
                            <a class="btn btn-sm btn-primary m-t-n-xs col-sm-2 pull-right" style="font-family: open sans,Helvetica Neue,Helvetica,Arial,sans-serif;font-size: 13px;" href="ViewCourseExamMapping.aspx?MenuID=71">                                
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12" id="divEditable" style="margin-bottom: 5px">
                                ...
                                <asp:Panel ID="pnlAction" runat="server">
                                    <div class="form-group  col-sm-4" runat="server" id="divAction">
                                        <div style="height: 29px; text-align: right"></div>
                                        <asp:Button ID="btnSave" runat="server" Text="Create Mapping " OnClientClick="if (!Validate()) {return false;}" OnClick="Save_Click" CssClass="btn btn-primary m-t-n-xs col-sm-8 btnSave" />
                                    </div>
                                    <div class="form-group  col-sm-3" runat="server" id="divAction1">
                        ...
                        <div class="row" runat="server" id="divExam" style="border: 1px solid #F3F3F4; padding-top: 5px; margin-top: 25px">
                            <div class="col-sm-12">
                                <div class="ibox">

                                    <h4 style="text-align: center; color: #676D7A" id="h2">Exam List</h4>

                                    <asp:CheckBoxList ID="chkExam" CssClass="inlineCheckBox" RepeatDirection="Horizontal" RepeatColumns="6" runat="server"></asp:CheckBoxList>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function Validate() {
         ...
         if ($('#<%=chkExam.ClientID %> input:checked').length > 0) {
                isValidSubject = true;
            }
